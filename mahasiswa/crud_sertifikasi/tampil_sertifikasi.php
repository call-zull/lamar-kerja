...
// Fetch competency data from the database
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="sertifikasiTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
        ...
        <div class="modal-content">
            <form id="addCompetencyForm" method="POST" action="process_add_sertifikasi.php" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="bukti_file">Bukti (upload berupa .pdf atau img, max 5mb)</label>
...
$(document).ready(function () {
    ...
    $('#addCompetencyForm').on('submit', function () {
        return validateForm('add');
    });

    // Custom validation for edit form
    $('#editCompetencyForm').on('submit', function () {
