                                    ...
                                    <?php if ($mahasiswa): ?>
                                        <div class="row">
                                            <div class="col-md-4 text-center">
                                                ...
                                                <h3 class="mt-2"><?php echo htmlspecialchars($mahasiswa['nama_mahasiswa']); ?></h3>
                                            </div>
                                            <div class="col-md-8">
                                                <p><strong>NIM:</strong> <?php echo htmlspecialchars($mahasiswa['nim']); ?></p>
                                                <p><strong>Jurusan:</strong> <?php echo htmlspecialchars($mahasiswa['nama_jurusan']); ?></p>
                                                <p><strong>Prodi:</strong> <?php echo htmlspecialchars($mahasiswa['nama_prodi']); ?></p>
                                                <p><strong>Jenis Kelamin:</strong> <?php echo htmlspecialchars($mahasiswa['jk']); ?></p>
                                                <p><strong>Tahun Masuk:</strong> <?php echo htmlspecialchars($mahasiswa['tahun_masuk']); ?></p>
                                                <p><strong>Status:</strong> <?php echo htmlspecialchars($mahasiswa['status']); ?></p>
                                                    ...
                                                    <?php if ($sertifikasi): ?>
                                                        <?php foreach ($sertifikasi as $index => $row): ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="../../assets/mahasiswa/sertifikasi/<?php echo htmlspecialchars($row['bukti']); ?>" target="_blank">Lihat Bukti</a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                                        <tr><td colspan="7">Tidak ada data sertifikasi.</td></tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                        </div>
                                                    ...
                                                    <?php if ($lomba): ?>
                                                        <?php foreach ($lomba as $index => $row): ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo htmlspecialchars($row['tanggal_pelaksanaan']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['tempat_pelaksanaan']); ?></td>
                                                                <td><a href="../../assets/mahasiswa/lomba/<?php echo htmlspecialchars($row['bukti']); ?>" target="_blank">Lihat Bukti</a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                                        <tr><td colspan="9">Tidak ada data lomba.</td></tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                        </div>
                                                    ...
                                                    <?php if ($pelatihan): ?>
                                                        <?php foreach ($pelatihan as $index => $row): ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo htmlspecialchars($row['tempat_pelaksanaan']); ?></td>
                                                                <td><a href="../../assets/mahasiswa/pelatihan/<?php echo htmlspecialchars($row['bukti']); ?>" target="_blank">Lihat Bukti</a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                                        <tr><td colspan="10">Tidak ada data pelatihan.</td></tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                        </div>
                                                    ...
                                                    <?php if ($proyek): ?>
                                                        <?php foreach ($proyek as $index => $row): ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="../../assets/mahasiswa/proyek/<?php echo htmlspecialchars($row['bukti']); ?>" target="_blank">Lihat Bukti</a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                                        <tr><td colspan="8">Tidak ada data proyek.</td></tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (result.success) {
                        ...
                        $('.btn-container').html('<div class="status-container status-diterima">Pelamar Diterima</div>');
                    }
                }
            });
        } else {
    ...
    $('#tolakBtn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (result.success) {
                    // Hide buttons and show status message
                    $('.btn-container').html('<div class="status-container status-ditolak">Pelamar Ditolak</div>');
                }
            }
        });
    });
