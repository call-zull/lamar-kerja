...
function getStudentPortfolios($pdo, $search = null) {
    $queries = [
        "SELECT m.id AS mahasiswa_id, m.nama_mahasiswa, m.nim, m.profile_image, j.nama_jurusan AS jurusan, p.nama_prodi AS prodi, m.keahlian, 
         ...
         WHERE p.nama_prodi = 'D3 Teknik Informatika'
    ...
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col text-center">
                ...
                <p class="lead">Kumpulan karya terbaik dari mahasiswa dan alumni D3 Teknik Informatika</p>
            </div>
        </div>
        ...
        <!-- Search Form -->
        <form method="GET" action="diploma_teknik_informatika.php" class="mb-4">
            <div class="row g-3">
                <div class="col-md-10">
