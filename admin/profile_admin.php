...
$sql = "SELECT a.id, a.nama_admin, p.nama_prodi AS prodi, j.nama_jurusan AS jurusan, a.email, a.profile_image 
        FROM admins a
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <?php if (!empty($admin['profile_image'])) : ?>
                                                <img src="../assets/admin/<?php echo $admin['profile_image']; ?>" class="img-fluid mb-3" alt="Admin Image">
                                            <?php else : ?>
                                                <img src="../assets/admin/default.jpg" class="img-fluid mb-3" alt="Default Image">
                                            <?php endif; ?>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="prodi" name="prodi" value="<?php echo $admin['prodi']; ?>" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label for="jurusan">Jurusan</label>
                                                <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?php echo $admin['jurusan']; ?>" disabled>
                                            </div>
                                            <div class="form-group">
