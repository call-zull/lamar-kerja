    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0">Tampil Data Proyek Mahasiswa</h4>
                    </div>
                    <div class="col-sm-6">
                                            ...
                                            <tbody>
                                                <?php foreach ($students as $index => $student): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#proyekModal" data-id="<?= $student['id'] ?>" data-nim="<?= htmlspecialchars($student['nim']) ?>">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg-custom" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="printPDF('proyekContent')">Cetak ke PDF</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#proyekModal').on('show.bs.modal', function (event) {
                ...
                var modalTitle = 'Proyek Mahasiswa - ' + mahasiswaNim;
                $('#proyekModalLabel').text(modalTitle);
        ...
        function printPDF(el) {
            ...
            var opt = {
                margin:       0.5,
                filename:     'Laporan_Proyek_Mahasiswa.pdf',
