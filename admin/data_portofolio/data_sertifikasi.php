    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <div class="row mb-2">
                        <div class="col-sm-6">
                            <!-- <h4 class="m-0">Tampil Data Sertifikasi Mahasiswa</h4> -->
                        </div>
                        <div class="col-sm-6">
                                            ...
                                            <tbody>
                                                <?php foreach ($students as $index => $student): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#portfolioModal" data-id="<?= $student['id'] ?>" data-nim="<?= htmlspecialchars($student['nim']) ?>">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="portfolioModalLabel">Sertifikasi Mahasiswa</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#portfolioModal').on('show.bs.modal', function (event) {
                ...
                var modalTitle = 'Sertifikasi Mahasiswa - ' + mahasiswaNim;
                $('#portfolioModalLabel').text(modalTitle);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        console.log(response); // Tambahkan ini untuk melihat respon di console browser
                        $('#portfolioContent').html(response);
                    },
                    error: function(xhr, status, error) {
                        console.error('AJAX Error:', status, error); // Tambahkan ini untuk menangkap error
                    }
                });
            });
        });
