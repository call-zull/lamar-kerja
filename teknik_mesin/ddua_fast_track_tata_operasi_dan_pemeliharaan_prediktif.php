...
function getStudentPortfolios($pdo, $search = null) {
    $queries = [
        "SELECT m.id AS mahasiswa_id, m.nama_mahasiswa, m.nim, m.profile_image, j.nama_jurusan AS jurusan, p.nama_prodi AS prodi, m.keahlian, 
         ...
         WHERE p.nama_prodi = 'D2 Fast Track Tata Operasi dan Pemeliharaan Prediktif Alat Berat'
...
<head>
    ...
    <title>Portofolio Mahasiswa Jurusan Teknik Mesin</title>
    ...
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col text-center">
                <h2>Portofolio Mahasiswa Jurusan Teknik Mesin</h2>
                <p class="lead">Kumpulan karya terbaik dari mahasiswa dan alumni D2 Fast Track Tata Operasi dan Pemeliharaan Prediktif Alat Berat</p>
            </div>
        </div>
        ...
        <!-- Search Form -->
        <form method="GET" action="ddua_fast_track_tata_operasi_dan_pemeliharaan_prediktif.php" class="mb-4">
            <div class="row g-3">
                <div class="col-md-10">
